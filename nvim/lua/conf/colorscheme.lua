    ...
    require('kanagawa').setup {
        ...
        overrides = function(colors)
            ...
            return {
                ...
                MiniStarterItemBullet = { fg = palette_colors.winterYellow, bg = palette_colors.sumiInk3 },
                MiniStarterSection = { fg = palette_colors.carpYellow, bg = palette_colors.sumiInk2, italic = true },
                MiniStarterItemPrefix = { fg = palette_colors.oldWhite, bg = palette_colors.sumiInk3 },
                MiniStarterItem = { fg = palette_colors.fujiGray, bg = palette_colors.sumiInk3 },
                MiniStarterInactive = { fg = palette_colors.fujiGray, bg = palette_colors.sumiInk3 },
                MiniStarterCurrent = { fg = palette_colors.fujiWhite, bg = palette_colors.waveBlue1 },
                MiniStarterQuery = { fg = palette_colors.crystalBlue, bg = palette_colors.sumiInk3 },
